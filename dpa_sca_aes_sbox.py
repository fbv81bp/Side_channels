# DPA SCA practice on AES S-box based on Hamming weights
...
leakages = [count1s(s_box[key_byte ^ plain]) for plain in choosen_plain_texts]
...
for assumed_key in range(256):
    ...
    print('assumed key:', assumed_key, 'correlation:', correlation)
